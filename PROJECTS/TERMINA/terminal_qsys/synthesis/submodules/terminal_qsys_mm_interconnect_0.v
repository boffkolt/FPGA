// terminal_qsys_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module terminal_qsys_mm_interconnect_0 (
		...
		input  wire        rbf_id_reset_reset_bridge_in_reset_reset,                          //                          rbf_id_reset_reset_bridge_in_reset.reset
		output wire [1:0]  base_address_ddr_s1_address,                                       //                                         base_address_ddr_s1.address
		output wire        base_address_ddr_s1_write,                                         //                                                            .write
		input  wire [31:0] base_address_ddr_s1_readdata,                                      //                                                            .readdata
		output wire [31:0] base_address_ddr_s1_writedata,                                     //                                                            .writedata
		output wire        base_address_ddr_s1_chipselect,                                    //                                                            .chipselect
		...
		output wire [0:0]  rbf_id_control_slave_address,                                      //                                        rbf_id_control_slave.address
		input  wire [31:0] rbf_id_control_slave_readdata,                                     //                                                            .readdata
	...
	wire   [31:0] rbf_id_control_slave_agent_m0_readdata;                   // rbf_id_control_slave_translator:uav_readdata -> rbf_id_control_slave_agent:m0_readdata
	wire          rbf_id_control_slave_agent_m0_waitrequest;                // rbf_id_control_slave_translator:uav_waitrequest -> rbf_id_control_slave_agent:m0_waitrequest
	wire          rbf_id_control_slave_agent_m0_debugaccess;                // rbf_id_control_slave_agent:m0_debugaccess -> rbf_id_control_slave_translator:uav_debugaccess
	wire   [20:0] rbf_id_control_slave_agent_m0_address;                    // rbf_id_control_slave_agent:m0_address -> rbf_id_control_slave_translator:uav_address
	wire    [3:0] rbf_id_control_slave_agent_m0_byteenable;                 // rbf_id_control_slave_agent:m0_byteenable -> rbf_id_control_slave_translator:uav_byteenable
	wire          rbf_id_control_slave_agent_m0_read;                       // rbf_id_control_slave_agent:m0_read -> rbf_id_control_slave_translator:uav_read
	wire          rbf_id_control_slave_agent_m0_readdatavalid;              // rbf_id_control_slave_translator:uav_readdatavalid -> rbf_id_control_slave_agent:m0_readdatavalid
	wire          rbf_id_control_slave_agent_m0_lock;                       // rbf_id_control_slave_agent:m0_lock -> rbf_id_control_slave_translator:uav_lock
	wire   [31:0] rbf_id_control_slave_agent_m0_writedata;                  // rbf_id_control_slave_agent:m0_writedata -> rbf_id_control_slave_translator:uav_writedata
	wire          rbf_id_control_slave_agent_m0_write;                      // rbf_id_control_slave_agent:m0_write -> rbf_id_control_slave_translator:uav_write
	wire    [2:0] rbf_id_control_slave_agent_m0_burstcount;                 // rbf_id_control_slave_agent:m0_burstcount -> rbf_id_control_slave_translator:uav_burstcount
	wire          rbf_id_control_slave_agent_rf_source_valid;               // rbf_id_control_slave_agent:rf_source_valid -> rbf_id_control_slave_agent_rsp_fifo:in_valid
	wire  [116:0] rbf_id_control_slave_agent_rf_source_data;                // rbf_id_control_slave_agent:rf_source_data -> rbf_id_control_slave_agent_rsp_fifo:in_data
	wire          rbf_id_control_slave_agent_rf_source_ready;               // rbf_id_control_slave_agent_rsp_fifo:in_ready -> rbf_id_control_slave_agent:rf_source_ready
	wire          rbf_id_control_slave_agent_rf_source_startofpacket;       // rbf_id_control_slave_agent:rf_source_startofpacket -> rbf_id_control_slave_agent_rsp_fifo:in_startofpacket
	wire          rbf_id_control_slave_agent_rf_source_endofpacket;         // rbf_id_control_slave_agent:rf_source_endofpacket -> rbf_id_control_slave_agent_rsp_fifo:in_endofpacket
	wire          rbf_id_control_slave_agent_rsp_fifo_out_valid;            // rbf_id_control_slave_agent_rsp_fifo:out_valid -> rbf_id_control_slave_agent:rf_sink_valid
	wire  [116:0] rbf_id_control_slave_agent_rsp_fifo_out_data;             // rbf_id_control_slave_agent_rsp_fifo:out_data -> rbf_id_control_slave_agent:rf_sink_data
	wire          rbf_id_control_slave_agent_rsp_fifo_out_ready;            // rbf_id_control_slave_agent:rf_sink_ready -> rbf_id_control_slave_agent_rsp_fifo:out_ready
	wire          rbf_id_control_slave_agent_rsp_fifo_out_startofpacket;    // rbf_id_control_slave_agent_rsp_fifo:out_startofpacket -> rbf_id_control_slave_agent:rf_sink_startofpacket
	wire          rbf_id_control_slave_agent_rsp_fifo_out_endofpacket;      // rbf_id_control_slave_agent_rsp_fifo:out_endofpacket -> rbf_id_control_slave_agent:rf_sink_endofpacket
	wire          rbf_id_control_slave_agent_rdata_fifo_src_valid;          // rbf_id_control_slave_agent:rdata_fifo_src_valid -> rbf_id_control_slave_agent_rdata_fifo:in_valid
	wire   [33:0] rbf_id_control_slave_agent_rdata_fifo_src_data;           // rbf_id_control_slave_agent:rdata_fifo_src_data -> rbf_id_control_slave_agent_rdata_fifo:in_data
	wire          rbf_id_control_slave_agent_rdata_fifo_src_ready;          // rbf_id_control_slave_agent_rdata_fifo:in_ready -> rbf_id_control_slave_agent:rdata_fifo_src_ready
	...
	wire  [116:0] state_s1_agent_rf_source_data;                            // state_s1_agent:rf_source_data -> state_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] state_s1_agent_rsp_fifo_out_data;                         // state_s1_agent_rsp_fifo:out_data -> state_s1_agent:rf_sink_data
	...
	wire          state_s1_agent_rdata_fifo_src_valid;                      // state_s1_agent:rdata_fifo_src_valid -> state_s1_agent_rdata_fifo:in_valid
	wire   [33:0] state_s1_agent_rdata_fifo_src_data;                       // state_s1_agent:rdata_fifo_src_data -> state_s1_agent_rdata_fifo:in_data
	wire          state_s1_agent_rdata_fifo_src_ready;                      // state_s1_agent_rdata_fifo:in_ready -> state_s1_agent:rdata_fifo_src_ready
	...
	wire   [20:0] control_s1_agent_m0_address;                              // control_s1_agent:m0_address -> control_s1_translator:uav_address
	...
	wire  [116:0] control_s1_agent_rf_source_data;                          // control_s1_agent:rf_source_data -> control_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] control_s1_agent_rsp_fifo_out_data;                       // control_s1_agent_rsp_fifo:out_data -> control_s1_agent:rf_sink_data
	...
	wire   [31:0] base_address_ddr_s1_agent_m0_readdata;                    // base_address_ddr_s1_translator:uav_readdata -> base_address_ddr_s1_agent:m0_readdata
	wire          base_address_ddr_s1_agent_m0_waitrequest;                 // base_address_ddr_s1_translator:uav_waitrequest -> base_address_ddr_s1_agent:m0_waitrequest
	wire          base_address_ddr_s1_agent_m0_debugaccess;                 // base_address_ddr_s1_agent:m0_debugaccess -> base_address_ddr_s1_translator:uav_debugaccess
	wire   [20:0] base_address_ddr_s1_agent_m0_address;                     // base_address_ddr_s1_agent:m0_address -> base_address_ddr_s1_translator:uav_address
	wire    [3:0] base_address_ddr_s1_agent_m0_byteenable;                  // base_address_ddr_s1_agent:m0_byteenable -> base_address_ddr_s1_translator:uav_byteenable
	wire          base_address_ddr_s1_agent_m0_read;                        // base_address_ddr_s1_agent:m0_read -> base_address_ddr_s1_translator:uav_read
	wire          base_address_ddr_s1_agent_m0_readdatavalid;               // base_address_ddr_s1_translator:uav_readdatavalid -> base_address_ddr_s1_agent:m0_readdatavalid
	wire          base_address_ddr_s1_agent_m0_lock;                        // base_address_ddr_s1_agent:m0_lock -> base_address_ddr_s1_translator:uav_lock
	wire   [31:0] base_address_ddr_s1_agent_m0_writedata;                   // base_address_ddr_s1_agent:m0_writedata -> base_address_ddr_s1_translator:uav_writedata
	wire          base_address_ddr_s1_agent_m0_write;                       // base_address_ddr_s1_agent:m0_write -> base_address_ddr_s1_translator:uav_write
	wire    [2:0] base_address_ddr_s1_agent_m0_burstcount;                  // base_address_ddr_s1_agent:m0_burstcount -> base_address_ddr_s1_translator:uav_burstcount
	wire          base_address_ddr_s1_agent_rf_source_valid;                // base_address_ddr_s1_agent:rf_source_valid -> base_address_ddr_s1_agent_rsp_fifo:in_valid
	wire  [116:0] base_address_ddr_s1_agent_rf_source_data;                 // base_address_ddr_s1_agent:rf_source_data -> base_address_ddr_s1_agent_rsp_fifo:in_data
	wire          base_address_ddr_s1_agent_rf_source_ready;                // base_address_ddr_s1_agent_rsp_fifo:in_ready -> base_address_ddr_s1_agent:rf_source_ready
	wire          base_address_ddr_s1_agent_rf_source_startofpacket;        // base_address_ddr_s1_agent:rf_source_startofpacket -> base_address_ddr_s1_agent_rsp_fifo:in_startofpacket
	wire          base_address_ddr_s1_agent_rf_source_endofpacket;          // base_address_ddr_s1_agent:rf_source_endofpacket -> base_address_ddr_s1_agent_rsp_fifo:in_endofpacket
	wire          base_address_ddr_s1_agent_rsp_fifo_out_valid;             // base_address_ddr_s1_agent_rsp_fifo:out_valid -> base_address_ddr_s1_agent:rf_sink_valid
	wire  [116:0] base_address_ddr_s1_agent_rsp_fifo_out_data;              // base_address_ddr_s1_agent_rsp_fifo:out_data -> base_address_ddr_s1_agent:rf_sink_data
	wire          base_address_ddr_s1_agent_rsp_fifo_out_ready;             // base_address_ddr_s1_agent:rf_sink_ready -> base_address_ddr_s1_agent_rsp_fifo:out_ready
	wire          base_address_ddr_s1_agent_rsp_fifo_out_startofpacket;     // base_address_ddr_s1_agent_rsp_fifo:out_startofpacket -> base_address_ddr_s1_agent:rf_sink_startofpacket
	wire          base_address_ddr_s1_agent_rsp_fifo_out_endofpacket;       // base_address_ddr_s1_agent_rsp_fifo:out_endofpacket -> base_address_ddr_s1_agent:rf_sink_endofpacket
	wire          base_address_ddr_s1_agent_rdata_fifo_src_valid;           // base_address_ddr_s1_agent:rdata_fifo_src_valid -> base_address_ddr_s1_agent_rdata_fifo:in_valid
	wire   [33:0] base_address_ddr_s1_agent_rdata_fifo_src_data;            // base_address_ddr_s1_agent:rdata_fifo_src_data -> base_address_ddr_s1_agent_rdata_fifo:in_data
	wire          base_address_ddr_s1_agent_rdata_fifo_src_ready;           // base_address_ddr_s1_agent_rdata_fifo:in_ready -> base_address_ddr_s1_agent:rdata_fifo_src_ready
	...
	wire          rbf_id_control_slave_agent_rp_valid;                      // rbf_id_control_slave_agent:rp_valid -> router_002:sink_valid
	wire  [115:0] rbf_id_control_slave_agent_rp_data;                       // rbf_id_control_slave_agent:rp_data -> router_002:sink_data
	wire          rbf_id_control_slave_agent_rp_ready;                      // router_002:sink_ready -> rbf_id_control_slave_agent:rp_ready
	wire          rbf_id_control_slave_agent_rp_startofpacket;              // rbf_id_control_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          rbf_id_control_slave_agent_rp_endofpacket;                // rbf_id_control_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          state_s1_agent_rp_valid;                                  // state_s1_agent:rp_valid -> router_003:sink_valid
	wire  [115:0] state_s1_agent_rp_data;                                   // state_s1_agent:rp_data -> router_003:sink_data
	wire          state_s1_agent_rp_ready;                                  // router_003:sink_ready -> state_s1_agent:rp_ready
	wire          state_s1_agent_rp_startofpacket;                          // state_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          state_s1_agent_rp_endofpacket;                            // state_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          control_s1_agent_rp_valid;                                // control_s1_agent:rp_valid -> router_004:sink_valid
	wire  [115:0] control_s1_agent_rp_data;                                 // control_s1_agent:rp_data -> router_004:sink_data
	wire          control_s1_agent_rp_ready;                                // router_004:sink_ready -> control_s1_agent:rp_ready
	wire          control_s1_agent_rp_startofpacket;                        // control_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          control_s1_agent_rp_endofpacket;                          // control_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire          base_address_ddr_s1_agent_rp_valid;                       // base_address_ddr_s1_agent:rp_valid -> router_005:sink_valid
	wire  [115:0] base_address_ddr_s1_agent_rp_data;                        // base_address_ddr_s1_agent:rp_data -> router_005:sink_data
	wire          base_address_ddr_s1_agent_rp_ready;                       // router_005:sink_ready -> base_address_ddr_s1_agent:rp_ready
	wire          base_address_ddr_s1_agent_rp_startofpacket;               // base_address_ddr_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          base_address_ddr_s1_agent_rp_endofpacket;                 // base_address_ddr_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                        // cmd_mux:src_valid -> rbf_id_control_slave_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> rbf_id_control_slave_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                        // rbf_id_control_slave_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [5:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> rbf_id_control_slave_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                // cmd_mux:src_startofpacket -> rbf_id_control_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                  // cmd_mux:src_endofpacket -> rbf_id_control_slave_burst_adapter:sink0_endofpacket
	wire          rbf_id_control_slave_burst_adapter_source0_valid;         // rbf_id_control_slave_burst_adapter:source0_valid -> rbf_id_control_slave_agent:cp_valid
	wire  [115:0] rbf_id_control_slave_burst_adapter_source0_data;          // rbf_id_control_slave_burst_adapter:source0_data -> rbf_id_control_slave_agent:cp_data
	wire          rbf_id_control_slave_burst_adapter_source0_ready;         // rbf_id_control_slave_agent:cp_ready -> rbf_id_control_slave_burst_adapter:source0_ready
	wire    [5:0] rbf_id_control_slave_burst_adapter_source0_channel;       // rbf_id_control_slave_burst_adapter:source0_channel -> rbf_id_control_slave_agent:cp_channel
	wire          rbf_id_control_slave_burst_adapter_source0_startofpacket; // rbf_id_control_slave_burst_adapter:source0_startofpacket -> rbf_id_control_slave_agent:cp_startofpacket
	wire          rbf_id_control_slave_burst_adapter_source0_endofpacket;   // rbf_id_control_slave_burst_adapter:source0_endofpacket -> rbf_id_control_slave_agent:cp_endofpacket
	wire          cmd_mux_001_src_valid;                                    // cmd_mux_001:src_valid -> state_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> state_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // state_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [5:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> state_s1_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                            // cmd_mux_001:src_startofpacket -> state_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                              // cmd_mux_001:src_endofpacket -> state_s1_burst_adapter:sink0_endofpacket
	wire          state_s1_burst_adapter_source0_valid;                     // state_s1_burst_adapter:source0_valid -> state_s1_agent:cp_valid
	wire  [115:0] state_s1_burst_adapter_source0_data;                      // state_s1_burst_adapter:source0_data -> state_s1_agent:cp_data
	wire          state_s1_burst_adapter_source0_ready;                     // state_s1_agent:cp_ready -> state_s1_burst_adapter:source0_ready
	wire    [5:0] state_s1_burst_adapter_source0_channel;                   // state_s1_burst_adapter:source0_channel -> state_s1_agent:cp_channel
	wire          state_s1_burst_adapter_source0_startofpacket;             // state_s1_burst_adapter:source0_startofpacket -> state_s1_agent:cp_startofpacket
	wire          state_s1_burst_adapter_source0_endofpacket;               // state_s1_burst_adapter:source0_endofpacket -> state_s1_agent:cp_endofpacket
	wire          cmd_mux_002_src_valid;                                    // cmd_mux_002:src_valid -> control_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_002_src_data;                                     // cmd_mux_002:src_data -> control_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                    // control_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [5:0] cmd_mux_002_src_channel;                                  // cmd_mux_002:src_channel -> control_s1_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                            // cmd_mux_002:src_startofpacket -> control_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                              // cmd_mux_002:src_endofpacket -> control_s1_burst_adapter:sink0_endofpacket
	wire          control_s1_burst_adapter_source0_valid;                   // control_s1_burst_adapter:source0_valid -> control_s1_agent:cp_valid
	wire  [115:0] control_s1_burst_adapter_source0_data;                    // control_s1_burst_adapter:source0_data -> control_s1_agent:cp_data
	wire          control_s1_burst_adapter_source0_ready;                   // control_s1_agent:cp_ready -> control_s1_burst_adapter:source0_ready
	wire    [5:0] control_s1_burst_adapter_source0_channel;                 // control_s1_burst_adapter:source0_channel -> control_s1_agent:cp_channel
	...
	wire          cmd_mux_003_src_valid;                                    // cmd_mux_003:src_valid -> base_address_ddr_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_003_src_data;                                     // cmd_mux_003:src_data -> base_address_ddr_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                    // base_address_ddr_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [5:0] cmd_mux_003_src_channel;                                  // cmd_mux_003:src_channel -> base_address_ddr_s1_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                            // cmd_mux_003:src_startofpacket -> base_address_ddr_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                              // cmd_mux_003:src_endofpacket -> base_address_ddr_s1_burst_adapter:sink0_endofpacket
	wire          base_address_ddr_s1_burst_adapter_source0_valid;          // base_address_ddr_s1_burst_adapter:source0_valid -> base_address_ddr_s1_agent:cp_valid
	wire  [115:0] base_address_ddr_s1_burst_adapter_source0_data;           // base_address_ddr_s1_burst_adapter:source0_data -> base_address_ddr_s1_agent:cp_data
	wire          base_address_ddr_s1_burst_adapter_source0_ready;          // base_address_ddr_s1_agent:cp_ready -> base_address_ddr_s1_burst_adapter:source0_ready
	wire    [5:0] base_address_ddr_s1_burst_adapter_source0_channel;        // base_address_ddr_s1_burst_adapter:source0_channel -> base_address_ddr_s1_agent:cp_channel
	wire          base_address_ddr_s1_burst_adapter_source0_startofpacket;  // base_address_ddr_s1_burst_adapter:source0_startofpacket -> base_address_ddr_s1_agent:cp_startofpacket
	wire          base_address_ddr_s1_burst_adapter_source0_endofpacket;    // base_address_ddr_s1_burst_adapter:source0_endofpacket -> base_address_ddr_s1_agent:cp_endofpacket
	...
	wire          rbf_id_control_slave_agent_rdata_fifo_out_valid;          // rbf_id_control_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] rbf_id_control_slave_agent_rdata_fifo_out_data;           // rbf_id_control_slave_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          rbf_id_control_slave_agent_rdata_fifo_out_ready;          // avalon_st_adapter:in_0_ready -> rbf_id_control_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                            // avalon_st_adapter:out_0_valid -> rbf_id_control_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                             // avalon_st_adapter:out_0_data -> rbf_id_control_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                            // rbf_id_control_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                            // avalon_st_adapter:out_0_error -> rbf_id_control_slave_agent:rdata_fifo_sink_error
	wire          state_s1_agent_rdata_fifo_out_valid;                      // state_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] state_s1_agent_rdata_fifo_out_data;                       // state_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          state_s1_agent_rdata_fifo_out_ready;                      // avalon_st_adapter_001:in_0_ready -> state_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                        // avalon_st_adapter_001:out_0_valid -> state_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                         // avalon_st_adapter_001:out_0_data -> state_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                        // state_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                        // avalon_st_adapter_001:out_0_error -> state_s1_agent:rdata_fifo_sink_error
	wire          control_s1_agent_rdata_fifo_out_valid;                    // control_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] control_s1_agent_rdata_fifo_out_data;                     // control_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          control_s1_agent_rdata_fifo_out_ready;                    // avalon_st_adapter_002:in_0_ready -> control_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_002_out_0_valid;                        // avalon_st_adapter_002:out_0_valid -> control_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                         // avalon_st_adapter_002:out_0_data -> control_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                        // control_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                        // avalon_st_adapter_002:out_0_error -> control_s1_agent:rdata_fifo_sink_error
	wire          base_address_ddr_s1_agent_rdata_fifo_out_valid;           // base_address_ddr_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] base_address_ddr_s1_agent_rdata_fifo_out_data;            // base_address_ddr_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          base_address_ddr_s1_agent_rdata_fifo_out_ready;           // avalon_st_adapter_003:in_0_ready -> base_address_ddr_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_003_out_0_valid;                        // avalon_st_adapter_003:out_0_valid -> base_address_ddr_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                         // avalon_st_adapter_003:out_0_data -> base_address_ddr_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                        // base_address_ddr_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                        // avalon_st_adapter_003:out_0_error -> base_address_ddr_s1_agent:rdata_fifo_sink_error
	...
	) rbf_id_control_slave_translator (
		.clk                    (clk_clk_clk),                                 //                      clk.clk
		.reset                  (rbf_id_reset_reset_bridge_in_reset_reset),    //                    reset.reset
		.uav_address            (rbf_id_control_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (rbf_id_control_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (rbf_id_control_slave_agent_m0_read),          //                         .read
		.uav_write              (rbf_id_control_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (rbf_id_control_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (rbf_id_control_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (rbf_id_control_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (rbf_id_control_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (rbf_id_control_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (rbf_id_control_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (rbf_id_control_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (rbf_id_control_slave_address),                //      avalon_anti_slave_0.address
		.av_readdata            (rbf_id_control_slave_readdata),               //                         .readdata
		.av_write               (),                                            //              (terminated)
		.av_read                (),                                            //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) base_address_ddr_s1_translator (
		.clk                    (clk_clk_clk),                                //                      clk.clk
		.reset                  (rbf_id_reset_reset_bridge_in_reset_reset),   //                    reset.reset
		.uav_address            (base_address_ddr_s1_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (base_address_ddr_s1_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (base_address_ddr_s1_agent_m0_read),          //                         .read
		.uav_write              (base_address_ddr_s1_agent_m0_write),         //                         .write
		.uav_waitrequest        (base_address_ddr_s1_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (base_address_ddr_s1_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (base_address_ddr_s1_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (base_address_ddr_s1_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (base_address_ddr_s1_agent_m0_writedata),     //                         .writedata
		.uav_lock               (base_address_ddr_s1_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (base_address_ddr_s1_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (base_address_ddr_s1_address),                //      avalon_anti_slave_0.address
		.av_write               (base_address_ddr_s1_write),                  //                         .write
		.av_readdata            (base_address_ddr_s1_readdata),               //                         .readdata
		.av_writedata           (base_address_ddr_s1_writedata),              //                         .writedata
		.av_chipselect          (base_address_ddr_s1_chipselect),             //                         .chipselect
		.av_read                (),                                           //              (terminated)
		.av_begintransfer       (),                                           //              (terminated)
		.av_beginbursttransfer  (),                                           //              (terminated)
		.av_burstcount          (),                                           //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) rbf_id_control_slave_agent (
		.clk                     (clk_clk_clk),                                              //             clk.clk
		.reset                   (rbf_id_reset_reset_bridge_in_reset_reset),                 //       clk_reset.reset
		.m0_address              (rbf_id_control_slave_agent_m0_address),                    //              m0.address
		.m0_burstcount           (rbf_id_control_slave_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (rbf_id_control_slave_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (rbf_id_control_slave_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (rbf_id_control_slave_agent_m0_lock),                       //                .lock
		.m0_readdata             (rbf_id_control_slave_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (rbf_id_control_slave_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (rbf_id_control_slave_agent_m0_read),                       //                .read
		.m0_waitrequest          (rbf_id_control_slave_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (rbf_id_control_slave_agent_m0_writedata),                  //                .writedata
		.m0_write                (rbf_id_control_slave_agent_m0_write),                      //                .write
		.rp_endofpacket          (rbf_id_control_slave_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (rbf_id_control_slave_agent_rp_ready),                      //                .ready
		.rp_valid                (rbf_id_control_slave_agent_rp_valid),                      //                .valid
		.rp_data                 (rbf_id_control_slave_agent_rp_data),                       //                .data
		.rp_startofpacket        (rbf_id_control_slave_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (rbf_id_control_slave_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (rbf_id_control_slave_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (rbf_id_control_slave_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (rbf_id_control_slave_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (rbf_id_control_slave_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (rbf_id_control_slave_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (rbf_id_control_slave_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (rbf_id_control_slave_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (rbf_id_control_slave_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (rbf_id_control_slave_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (rbf_id_control_slave_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (rbf_id_control_slave_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (rbf_id_control_slave_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (rbf_id_control_slave_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (rbf_id_control_slave_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (rbf_id_control_slave_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                            // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                            //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                             //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                            //                .error
		.rdata_fifo_src_ready    (rbf_id_control_slave_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (rbf_id_control_slave_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (rbf_id_control_slave_agent_rdata_fifo_src_data),           //                .data
	...
	) rbf_id_control_slave_agent_rsp_fifo (
		.clk               (clk_clk_clk),                                           //       clk.clk
		.reset             (rbf_id_reset_reset_bridge_in_reset_reset),              // clk_reset.reset
		.in_data           (rbf_id_control_slave_agent_rf_source_data),             //        in.data
		.in_valid          (rbf_id_control_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (rbf_id_control_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (rbf_id_control_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (rbf_id_control_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (rbf_id_control_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (rbf_id_control_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (rbf_id_control_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (rbf_id_control_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (rbf_id_control_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) rbf_id_control_slave_agent_rdata_fifo (
		.clk               (clk_clk_clk),                                     //       clk.clk
		.reset             (rbf_id_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
		.in_data           (rbf_id_control_slave_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (rbf_id_control_slave_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (rbf_id_control_slave_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (rbf_id_control_slave_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (rbf_id_control_slave_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (rbf_id_control_slave_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                           // (terminated)
		.csr_read          (1'b0),                                            // (terminated)
		.csr_write         (1'b0),                                            // (terminated)
		.csr_readdata      (),                                                // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (state_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (state_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (state_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (state_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (state_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (state_s1_burst_adapter_source0_channel),       //                .channel
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) state_s1_agent_rdata_fifo (
		.clk               (clk_clk_clk),                              //       clk.clk
		.reset             (rbf_id_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (state_s1_agent_rdata_fifo_src_data),       //        in.data
		.in_valid          (state_s1_agent_rdata_fifo_src_valid),      //          .valid
		.in_ready          (state_s1_agent_rdata_fifo_src_ready),      //          .ready
		.out_data          (state_s1_agent_rdata_fifo_out_data),       //       out.data
		.out_valid         (state_s1_agent_rdata_fifo_out_valid),      //          .valid
		.out_ready         (state_s1_agent_rdata_fifo_out_ready),      //          .ready
		.csr_address       (2'b00),                                    // (terminated)
		.csr_read          (1'b0),                                     // (terminated)
		.csr_write         (1'b0),                                     // (terminated)
		.csr_readdata      (),                                         // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) base_address_ddr_s1_agent (
		.clk                     (clk_clk_clk),                                             //             clk.clk
		.reset                   (rbf_id_reset_reset_bridge_in_reset_reset),                //       clk_reset.reset
		.m0_address              (base_address_ddr_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (base_address_ddr_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (base_address_ddr_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (base_address_ddr_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (base_address_ddr_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (base_address_ddr_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (base_address_ddr_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (base_address_ddr_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (base_address_ddr_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (base_address_ddr_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (base_address_ddr_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (base_address_ddr_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (base_address_ddr_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (base_address_ddr_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (base_address_ddr_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (base_address_ddr_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (base_address_ddr_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (base_address_ddr_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (base_address_ddr_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (base_address_ddr_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (base_address_ddr_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (base_address_ddr_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (base_address_ddr_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (base_address_ddr_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (base_address_ddr_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (base_address_ddr_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (base_address_ddr_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (base_address_ddr_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (base_address_ddr_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (base_address_ddr_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (base_address_ddr_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (base_address_ddr_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                       //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                        //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                       //                .error
		.rdata_fifo_src_ready    (base_address_ddr_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (base_address_ddr_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (base_address_ddr_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                   //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                     //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) base_address_ddr_s1_agent_rsp_fifo (
		.clk               (clk_clk_clk),                                          //       clk.clk
		.reset             (rbf_id_reset_reset_bridge_in_reset_reset),             // clk_reset.reset
		.in_data           (base_address_ddr_s1_agent_rf_source_data),             //        in.data
		.in_valid          (base_address_ddr_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (base_address_ddr_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (base_address_ddr_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (base_address_ddr_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (base_address_ddr_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (base_address_ddr_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (base_address_ddr_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (base_address_ddr_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (base_address_ddr_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                // (terminated)
		.csr_read          (1'b0),                                                 // (terminated)
		.csr_write         (1'b0),                                                 // (terminated)
		.csr_readdata      (),                                                     // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) base_address_ddr_s1_agent_rdata_fifo (
		.clk               (clk_clk_clk),                                    //       clk.clk
		.reset             (rbf_id_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		.in_data           (base_address_ddr_s1_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (base_address_ddr_s1_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (base_address_ddr_s1_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (base_address_ddr_s1_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (base_address_ddr_s1_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (base_address_ddr_s1_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	terminal_qsys_mm_interconnect_0_router router (
	...
	terminal_qsys_mm_interconnect_0_router router_001 (
	...
	terminal_qsys_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (rbf_id_control_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (rbf_id_control_slave_agent_rp_valid),         //          .valid
		.sink_data          (rbf_id_control_slave_agent_rp_data),          //          .data
		.sink_startofpacket (rbf_id_control_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (rbf_id_control_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_clk_clk),                                 //       clk.clk
		.reset              (rbf_id_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
	...
	terminal_qsys_mm_interconnect_0_router_002 router_003 (
	...
	terminal_qsys_mm_interconnect_0_router_002 router_004 (
	...
	terminal_qsys_mm_interconnect_0_router_002 router_005 (
		.sink_ready         (base_address_ddr_s1_agent_rp_ready),         //      sink.ready
		.sink_valid         (base_address_ddr_s1_agent_rp_valid),         //          .valid
		.sink_data          (base_address_ddr_s1_agent_rp_data),          //          .data
		.sink_startofpacket (base_address_ddr_s1_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (base_address_ddr_s1_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_clk_clk),                                //       clk.clk
		.reset              (rbf_id_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
	...
	terminal_qsys_mm_interconnect_0_router_002 router_006 (
	...
	terminal_qsys_mm_interconnect_0_router_002 router_007 (
	...
	altera_merlin_burst_adapter #(
	...
	) rbf_id_control_slave_burst_adapter (
		.clk                   (clk_clk_clk),                                              //       cr0.clk
		.reset                 (rbf_id_reset_reset_bridge_in_reset_reset),                 // cr0_reset.reset
		...
		.source0_valid         (rbf_id_control_slave_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (rbf_id_control_slave_burst_adapter_source0_data),          //          .data
		.source0_channel       (rbf_id_control_slave_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (rbf_id_control_slave_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (rbf_id_control_slave_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (rbf_id_control_slave_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (state_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (state_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (state_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (state_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (state_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (state_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) base_address_ddr_s1_burst_adapter (
		.clk                   (clk_clk_clk),                                             //       cr0.clk
		.reset                 (rbf_id_reset_reset_bridge_in_reset_reset),                // cr0_reset.reset
		...
		.source0_valid         (base_address_ddr_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (base_address_ddr_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (base_address_ddr_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (base_address_ddr_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (base_address_ddr_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (base_address_ddr_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	terminal_qsys_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_clk_clk),                                                       //        clk.clk
		.reset              (hps_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	terminal_qsys_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_clk_clk),                                                       //        clk.clk
		.reset              (hps_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	terminal_qsys_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_clk_clk),                              //       clk.clk
		.reset               (rbf_id_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	terminal_qsys_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_clk_clk),                              //       clk.clk
		.reset               (rbf_id_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	terminal_qsys_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_clk_clk),                              //       clk.clk
		.reset               (rbf_id_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	terminal_qsys_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_clk_clk),                              //       clk.clk
		.reset               (rbf_id_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	terminal_qsys_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_clk_clk),                              //       clk.clk
		.reset               (rbf_id_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	terminal_qsys_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_clk_clk),                              //       clk.clk
		.reset               (rbf_id_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	terminal_qsys_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_clk_clk),                              //       clk.clk
		.reset              (rbf_id_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	terminal_qsys_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_clk_clk),                              //       clk.clk
		.reset              (rbf_id_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	terminal_qsys_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_clk_clk),                              //       clk.clk
		.reset              (rbf_id_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	terminal_qsys_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_clk_clk),                              //       clk.clk
		.reset              (rbf_id_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	terminal_qsys_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_clk_clk),                              //       clk.clk
		.reset              (rbf_id_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	terminal_qsys_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_clk_clk),                              //       clk.clk
		.reset              (rbf_id_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	terminal_qsys_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_clk_clk),                                                       //       clk.clk
		.reset               (hps_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	terminal_qsys_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_clk_clk),                                                       //       clk.clk
		.reset               (hps_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	terminal_qsys_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
		...
		.in_rst_0_reset (rbf_id_reset_reset_bridge_in_reset_reset),        // in_rst_0.reset
		.in_0_data      (rbf_id_control_slave_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (rbf_id_control_slave_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (rbf_id_control_slave_agent_rdata_fifo_out_ready), //         .ready
	...
	terminal_qsys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_clk_clk),                              // in_clk_0.clk
		.in_rst_0_reset (rbf_id_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (state_s1_agent_rdata_fifo_out_data),       //     in_0.data
		.in_0_valid     (state_s1_agent_rdata_fifo_out_valid),      //         .valid
		.in_0_ready     (state_s1_agent_rdata_fifo_out_ready),      //         .ready
	...
	terminal_qsys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_clk_clk),                                    // in_clk_0.clk
		.in_rst_0_reset (rbf_id_reset_reset_bridge_in_reset_reset),       // in_rst_0.reset
		.in_0_data      (base_address_ddr_s1_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (base_address_ddr_s1_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (base_address_ddr_s1_agent_rdata_fifo_out_ready), //         .ready
